...
public class AO{
    public static String get(String cookie){    
       ...
       String url = "https://itfjira.mercedes-benz-finance.com.cn/jira/secure/enav/";
    ...
    public static String Parser(String response){
        String userAO = "";
            ...
            //System.out.println(response);
            int begin = response.lastIndexOf("zEncKeyVal");
            System.out.println(response.substring(begin, begin+104));
            //int end = response.lastIndexOf("</name><html>");
            userAO = response.substring(begin+14, begin+102);
